...
description: "Bitcoin testnet support arrives on Chainstack, plus a new Growth pricing plan with reduced fixed and usage costs and uniform rates across cloud providers."
---
