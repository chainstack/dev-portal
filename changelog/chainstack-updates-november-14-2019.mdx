...
description: "Bitcoin 0.18 Dedicated Node support with Bolt sync, free elastic mainnet node access, network and node statuses, and updated billing usage line items."
---
