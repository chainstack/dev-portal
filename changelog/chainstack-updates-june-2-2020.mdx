...
description: "Corda 4.4 and Quorum 2.6.0 support, Tessera 0.10.5, a date-and-container node log viewer, dynamic resource visibility, and CorDapp install notifications."
---
- **Protocols**
	- Corda 4.4 support.
