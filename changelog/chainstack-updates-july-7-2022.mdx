...
description: "Harmony moves from testnet to devnet, Tezos migrates to Ithacanet, shared nodes rebrand to elastic nodes, and Warp transactions launch on Ethereum nodes."
---
- **Protocols**.
...
- **Node naming**. Shared nodes are now elastic nodes to reflect the underlying architecture and scalable infrastructure.
- **APIs**.
