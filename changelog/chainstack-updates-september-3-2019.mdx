...
description: "Protected endpoints for Quorum and Ethereum nodes, hourly Bolt snapshots, in-platform notifications, an activity log, and a full documentation overhaul."
---
