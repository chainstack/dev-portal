...
Ethereum API method allowing developers to receive real-time notifications regarding new block headers on the Ethereum blockchain; it sends notifications whenever a new block is added.
