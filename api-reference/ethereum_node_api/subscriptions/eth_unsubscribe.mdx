...
Ethereum API method that allows a client to unsubscribe from a specific subscription.
...
* [eth\_subscribe("newHeads")](/api-reference/ethereum-native-subscribe-newheads)
* [eth\_subscribe("newPendingTransactions")](/api-reference/ethereum-native-subscribe-newpendingtransactions)
* [eth\_subscribe("logs")](/api-reference/ethereum-native-subscribe-logs)
