...
* [subscribe("newBlockHeaders")](/api-reference/ethereum-subscribenewblockheaders)
* [subscribe("pendingTransactions")](/api-reference/ethereum-subscribependingtransactions)
* [subscribe("logs")](/api-reference/ethereum-subscribelogs)
* [subscribe("syncing")](/api-reference/ethereum-subscribesyncing)
