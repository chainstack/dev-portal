...
BNB API method that traces the execution of [eth\_call](/api-reference/bnb_node_api/eth_call) within the context of a specific block's execution. This method uses the final state of the parent block as its base and allows developers to trace the execution of a particular call.
