...
The `rootUnsubscribe` method in Solana allows a client to unsubscribe from a root subscription. This method can be used to cancel an existing subscription to root updates.

See also [rootSubscribe | Solana](/api-reference/rootsubscribe-solana).
