...
Arbitrum API method allowing developers to receive real-time notifications regarding new block headers on the Arbitrum blockchain; it sends notifications whenever a new block is added.
...
Use [eth\_unsubscribe](/api-reference/arbitrum-native-unsubscribe) to remove the subscription.
