...
* [subscribe("newBlockHeaders")](/api-reference/arbitrum-subscribenewblockheaders)
* [subscribe("logs")](/api-reference/arbitrum-subscribelogs)
* [subscribe("syncing")](/api-reference/arbitrum-subscribesyncing)
