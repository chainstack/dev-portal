...
<CardGroup cols={3}>
  <Card title="Ethereum" icon="ethereum" iconType="solid" href="/api-reference/ethereum-getting-started" horizontal/>
  <Card title="Ethereum Beacon Chain" icon="signal" iconType="solid" href="/api-reference/beacon-chain" horizontal/>
  <Card title="Polygon" icon="layer-group" iconType="solid" href="/api-reference/polygon-getting-started" horizontal/>
  <Card title="BNB Chain" icon="coins" iconType="solid" href="/api-reference/getting-started-bnb-chain" horizontal/>
  <Card title="Base" icon="layer-group" iconType="solid" href="/api-reference/base-api-reference" horizontal/>
  <Card title="Avalanche" icon="snowflake" iconType="solid" href="/api-reference/avalanche-getting-started" horizontal/>
  <Card title="Arbitrum" icon="layer-group" iconType="solid" href="/api-reference/arbitrum-getting-started" horizontal/>
  <Card title="zkSync Era" icon="layer-group" iconType="solid" href="/api-reference/getting-started-zksync" horizontal/>
  <Card title="Polygon zkEVM" icon="layer-group" iconType="solid" href="/api-reference/zkevm-getting-started" horizontal/>
  <Card title="Optimism" icon="layer-group" iconType="solid" href="/api-reference/optimism-api-reference" horizontal/>
  <Card title="Aurora" icon="sun" iconType="solid" href="/api-reference/getting-started-aurora" horizontal/>
  <Card title="Solana" icon="bolt" iconType="solid" href="/api-reference/solana-getting-started" horizontal/>
  <Card title="Ronin" icon="gamepad" iconType="solid" href="/api-reference/getting-started-ronin" horizontal/>
  <Card title="Gnosis Chain" icon="shield" iconType="solid" href="/api-reference/gnosis-getting-started" horizontal/>
  <Card title="Cronos" icon="coins" iconType="solid" href="/api-reference/getting-started-cronos" horizontal/>
  <Card title="Fantom" icon="bolt" iconType="solid" href="/api-reference/getting-started-fantom" horizontal/>
  <Card title="Bitcoin" icon="bitcoin" iconType="solid" href="/api-reference/bitcoin-api-reference" horizontal/>
  <Card title="Starknet" icon="layer-group" iconType="solid" href="/api-reference/getting-started-starknet" horizontal/>
</CardGroup>
...
To start with the API, you must [create an API key](/api-reference/platform-api-getting-started#create-api-key).

For all available API operations, see [API reference](/api-reference/platform-api-getting-started).
...
- `method` — defines the method that is being called, in this case, [eth\_blockNumber](/api-reference/bnb_node_api/eth_blockNumber).
...
```
<Info>
 Find different ways to interact and retrieve data from the blockchain in the [Web3 libraries and tools guide](/api-reference/web3-libraries).
</Info>
