...
<CardGroup>
  <Card title="debug_traceBlockByHash" href="/api-reference/avalanche_node_api/debug_and_trace/debug_traceBlockByHash" icon="angle-right" horizontal />
  <Card title="debug_traceBlockByNumber" href="/api-reference/avalanche_node_api/debug_and_trace/debug_traceBlockByNumber" icon="angle-right" horizontal />
  <Card title="debug_traceCall" href="/api-reference/avalanche_node_api/debug_and_trace/debug_traceCall" icon="angle-right" horizontal />
  <Card title="debug_traceTransaction" href="/api-reference/avalanche_node_api/debug_and_trace/debug_traceTransaction" icon="angle-right" horizontal />
</CardGroup>
