...
<CardGroup cols={2}>
  <Card title="debug_traceBlockByHash" icon="angle-right" iconType="solid" href="/api-reference/ethereum_node_api/debug_and_trace/debug_traceBlockByHash" horizontal/>
  <Card title="debug_traceBlockByNumber" icon="angle-right" iconType="solid" href="/api-reference/ethereum_node_api/debug_and_trace/debug_traceBlockByNumber" horizontal/>
  <Card title="debug_traceTransaction" icon="angle-right" iconType="solid" href="/api-reference/ethereum_node_api/debug_and_trace/debug_traceTransaction" horizontal/>
  <Card title="debug_traceCall" icon="angle-right" iconType="solid" href="/api-reference/ethereum_node_api/debug_and_trace/debug_traceCall" horizontal/>
  <Card title="trace_transaction" icon="angle-right" iconType="solid" href="/api-reference/ethereum_node_api/debug_and_trace/trace_transaction" horizontal/>
  <Card title="trace_block" icon="angle-right" iconType="solid" href="/api-reference/ethereum_node_api/debug_and_trace/trace_block" horizontal/>
</CardGroup>
...
Find a guide to [Custom JS tracing | Ethereum](/api-reference/ethereum_node_api/debug_and_trace/custom_js_tracer) on the next page.
