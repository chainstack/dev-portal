...
description: "The `rootSubscribe` method in Solana allows developers to receive real-time notifications about changes to the root of the ledger. This subscription-based method provides updates whenever a new root is set."
---
