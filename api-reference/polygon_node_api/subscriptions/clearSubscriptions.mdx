...
* [subscribe("newBlockHeaders")](/api-reference/polygon-subscribenewblockheaders)
* [subscribe("pendingTransactions")](/api-reference/polygon-subscribependingtransactions)
* [subscribe("logs")](/api-reference/polygon-subscribelogs)
* [subscribe("syncing")](/api-reference/polygon-subscribesyncing)
