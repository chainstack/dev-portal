...
* [eth\_subscribe("newHeads")](/api-reference/polygon-native-subscribe-newheads)
* [eth\_subscribe("newPendingTransactions")](/api-reference/polygon-native-subscribe-newpendingtransactions)
* [eth\_subscribe("logs")](/api-reference/polygon-native-subscribe-logs)
