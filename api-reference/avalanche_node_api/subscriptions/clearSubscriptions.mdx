...
* [subscribe("newBlockHeaders")](/api-reference/avalanche-subscribenewblockheaders)
* [subscribe("pendingTransactions")](/api-reference/avalanche-subscribependingtransactions)
* [subscribe("logs")](/api-reference/avalanche-subscribelogs)
* [subscribe("syncing")](/api-reference/avalanche-subscribesyncing)
