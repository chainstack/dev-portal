...
Avalanche API method that allows a client to unsubscribe from a specific subscription.
...
* [eth\_subscribe("newHeads")](/api-reference/avalanche-native-subscribe-newheads)
* [eth\_subscribe("newPendingTransactions")](/api-reference/avalanche-native-subscribe-newpendingtransactions)
* [eth\_subscribe("logs")](/api-reference/avalanche-native-subscribe-logs)
