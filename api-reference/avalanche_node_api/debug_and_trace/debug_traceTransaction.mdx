...
<Note>
Find a complete [list of available built-in tracers](/api-reference/avalanche-debug-trace-rpc-methods#pre-built-javascript-based-tracers) in the debug and trace overview.
</Note>
