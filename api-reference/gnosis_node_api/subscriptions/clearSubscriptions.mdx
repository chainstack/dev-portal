...
* [subscribe("newBlockHeaders")](/api-reference/gnosis-subscribenewblockheaders)
* [subscribe("logs")](/api-reference/gnosis-subscribelogs)
* [subscribe("syncing")](/api-reference/gnosis-subscribesyncing)
