...
Gnosis Chain API method that allows a client to unsubscribe from a specific subscription.
...
* [eth\_subscribe("newHeads")](/api-reference/gnosis-native-subscribe-newheads)
* [eth\_subscribe("newPendingTransactions")](/api-reference/gnosis-native-subscribe-newpendingtransactions)
* [eth\_subscribe("logs")](/api-reference/gnosis-native-subscribe-logs)
