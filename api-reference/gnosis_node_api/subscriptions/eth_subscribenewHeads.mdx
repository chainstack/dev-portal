...
Gnosis Chain API method allowing developers to receive real-time notifications regarding new block headers on the Gnosis Chain; it sends notifications whenever a new block is added.
...
Use [eth\_unsubscribe](/api-reference/gnosis-native-unsubscribe) to remove the subscription.
