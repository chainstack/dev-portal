...
3. **web3.js**: Basic knowledge of web3.js and its purpose in interacting with Ethereum and other EVM-compatible blockchains. If you are new to web3.js, you can find many examples in the [Chainstack API reference](/api-reference/ethereum_node_api/blocks_info/eth_blockNumber).
...
Find more examples of how to use `web3.js` in the [Chainstack API docs](/api-reference/ethereum_node_api/blocks_info/eth_blockNumber).
...
Chainstack offers a unique feature, the [platform API](/api-reference/platform-api-getting-started); this means you can use a Chainstack API key to interact with your projects and nodes, fetch data about them, and even deploy nodes. The web3.js plugin integrates some of the platform API endpoints to get data.
