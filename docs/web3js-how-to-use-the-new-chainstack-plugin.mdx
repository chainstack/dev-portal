...
3. **web3.js**: Basic knowledge of web3.js and its purpose in interacting with Ethereum and other EVM-compatible blockchains. If you are new to web3.js, you can find many examples in the [Chainstack API reference](/reference/ethereum_node_api/blocks_info/eth_blockNumber).
...
Find more examples of how to use `web3.js` in the [Chainstack API docs](/reference/ethereum_node_api/blocks_info/eth_blockNumber).
