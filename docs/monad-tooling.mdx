...
2. In Rabby, navigate to **Settings** > **Add Custom Network**.
3. Add your Chainstack endpoint with chain ID `143`.

If Rabby already supports the network, use **Settings** > **Modify RPC URL** instead. See [Adding a custom RPC endpoint to Rabby](/docs/adding-a-custom-rpc-endpoint-to-rabby).
