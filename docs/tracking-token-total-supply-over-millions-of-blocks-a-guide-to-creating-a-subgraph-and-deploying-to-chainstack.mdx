...
Replace **`<ACCESS_TOKEN>`** with your access token from Chainstack Subgraphs hosting. Also before this action you need to add an elastic subgraph via the platform UI.
