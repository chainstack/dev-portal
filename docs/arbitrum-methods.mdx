...
See also [interactive Arbitrum API call examples](/api-reference/arbitrum-getting-started).
...
| arbtrace\_block                          | <Icon icon="square-check"  iconType="solid" />            |         |
| arbtrace\_call                           | <Icon icon="square-check"  iconType="solid" />            |         |
| arbtrace\_callMany                       | <Icon icon="square-check"  iconType="solid" />            |         |
| arbtrace\_filter                         | <Icon icon="square-check"  iconType="solid" />            |         |
| arbtrace\_replayBlockTransactions        | <Icon icon="square-check"  iconType="solid" />            |         |
| arbtrace\_replayTransaction              | <Icon icon="square-check"  iconType="solid" />            |         |
| arbtrace\_transaction                    | <Icon icon="square-check"  iconType="solid" />            |         |
