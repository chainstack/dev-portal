...
* Node side — The Flasblocks module is implemented on the [Base fork of the Reth node](https://github.com/base/node-reth).
...
* The sequencer-streamed Flasblocks & Flashblock states can then be retrieved by apps over the standard Base RPC endoints & methods:
...
See the results in the Chaistack Labs [base-flashblocks-transaction-latency-test](https://github.com/chainstacklabs/base-flashblocks-transaction-latency-test) repository:
...
See the Chaistack Labs [base-flashblocks-transaction-latency-test](https://github.com/chainstacklabs/base-flashblocks-transaction-latency-test) repository for the latency test too and the comprehensive README file.
