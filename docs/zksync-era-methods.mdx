...
| zks\_estimateFee                         | <Icon icon="square-check"  iconType="solid" />            |         |
| zks\_estimateGasL1ToL2                   | <Icon icon="square-check"  iconType="solid" />            |         |
| zks\_getAllAccountBalances               | <Icon icon="square-check"  iconType="solid" />            |         |
| zks\_getBlockDetails                     | <Icon icon="square-check"  iconType="solid" />            |         |
| zks\_getBridgeContracts                  | <Icon icon="square-check"  iconType="solid" />            |         |
| zks\_getBytecodeByHash                   | <Icon icon="square-check"  iconType="solid" />            |         |
| zks\_getConfirmedTokens                  | <Icon icon="square-check"  iconType="solid" />            |         |
| zks\_getL1BatchBlockRange                | <Icon icon="square-check"  iconType="solid" />            |         |
| zks\_getL1BatchDetails                   | <Icon icon="square-check"  iconType="solid" />            |         |
| zks\_getL2ToL1LogProof                   | <Icon icon="square-check"  iconType="solid" />            |         |
| zks\_getL2ToL1MsgProof                   | <Icon icon="square-check"  iconType="solid" />            |         |
| zks\_getMainContract                     | <Icon icon="square-check"  iconType="solid" />            |         |
| zks\_getRawBlockTransactions             | <Icon icon="square-check"  iconType="solid" />            |         |
| zks\_getTestnetPaymaster                 | <Icon icon="square-check"  iconType="solid" />            |         |
| zks\_getTokenPrice                       | <Icon icon="square-check"  iconType="solid" />            |         |
| zks\_getTransactionDetails               | <Icon icon="square-check"  iconType="solid" />            |         |
| zks\_L1BatchNumber                       | <Icon icon="square-check"  iconType="solid" />            |         |
| zks\_L1ChainId                           | <Icon icon="square-check"  iconType="solid" />            |         |
