...
description: "Smallest viable hardware to install and try Chainstack Self-Hosted before going to production: CPU, RAM, disk, and Kubernetes pod resource requirements."
---
