...
description: "Failed deployments now recover via a new revision, revisions track the initiating user, cp-bolt clears stuck PVCs, and cpctl patches single containers."
---
