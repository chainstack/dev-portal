...
description: "Helm is retired for a typed in-process provisioning pipeline, and bootstrap polling is bounded by an explicit presence state machine preventing worker hangs."
---
