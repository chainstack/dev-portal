...
description: "First non-beta release: new Ethereum evaluation presets, default telemetry, simpler installs and upgrades, Postgres resource limits, and UI refinements."
---
