---
title: "Hyperliquid: Infrastructure and RPC frequently asked questions"
...
<Note>
This section summarizes information from the official documentation. In case of discrepancies, refer to the source at [https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/rate-limits-and-user-limits](https://hyperliquid.gitbook.io/hyperliquid-docs/for-developers/api/rate-limits-and-user-limits).
</Note>

### IP-based limits

Weight represents a cost value assigned to each API request based on computational complexity. Requests consume weight from your 1200 weight/minute quota.
...
| High congestion throttle | 2x maker percentage | During high traffic, users limited to 2x their maker order proportion | — |
