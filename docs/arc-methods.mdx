...
Chainstack serves Arc Mainnet (chain ID `5042`) and Arc Testnet (chain ID `5042002`). Both networks run the same [arc-node](https://github.com/circlefin/arc-node) software, which is what enforces the restrictions described on this page. The availability below is verified against Chainstack Arc nodes.
