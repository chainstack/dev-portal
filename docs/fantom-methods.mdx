...
description: "Complete Fantom RPC methods reference for Chainstack nodes. Access Ethereum-compatible JSON-RPC, debug, trace, and Fantom-specific methods with availability status."
---
