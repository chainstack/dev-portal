...
1. [Create a Chainstack API key](/api-reference/platform-api-getting-started#create-api-key) and copy it, which will be similar to `Bearer y0urChainstackAPIkeyHer3`, then store it in your `.env` file as `CHAINSTACK`:
