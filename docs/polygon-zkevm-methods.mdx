...
| zkevm\_batchNumber                       | <Icon icon="square-check"  iconType="solid" />            |         |
| zkevm\_batchNumberByBlockNumber          | <Icon icon="square-check"  iconType="solid" />            |         |
| zkevm\_consolidatedBlockNumber           | <Icon icon="square-check"  iconType="solid" />            |         |
| zkevm\_estimateCounters                  | <Icon icon="square-check"  iconType="solid" />            |         |
| zkevm\_estimateGasPrice                  | <Icon icon="square-check"  iconType="solid" />            |         |
| zkevm\_getBatchByNumber                  | <Icon icon="square-check"  iconType="solid" />            |         |
| zkevm\_getBroadcastURI                   | <Icon icon="square-check"  iconType="solid" />            |         |
| zkevm\_isBlockConsolidated               | <Icon icon="square-check"  iconType="solid" />            |         |
| zkevm\_isBlockVirtualized                | <Icon icon="square-check"  iconType="solid" />            |         |
| zkevm\_verifiedBatchNumber               | <Icon icon="square-check"  iconType="solid" />            |         |
| zkevm\_virtualBatchNumber                | <Icon icon="square-check"  iconType="solid" />            |         |
...
| trace\_call                              | <Icon icon="xmark"  iconType="solid" />            |         |
| trace\_callMany                          | <Icon icon="xmark"  iconType="solid" />            |         |
| trace\_filter                            | <Icon icon="xmark"  iconType="solid" />            |         |
| trace\_rawTransaction                    | <Icon icon="xmark"  iconType="solid" />            |         |
| trace\_replayBlockTransactions           | <Icon icon="xmark"  iconType="solid" />            |         |
| trace\_replayTransaction                 | <Icon icon="xmark"  iconType="solid" />            |         |
