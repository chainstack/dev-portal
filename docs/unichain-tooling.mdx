---
title: "Unichain tooling"
description: "Unichain development tools guide. Use MetaMask, web3.py, ethers.js, Hardhat, Remix IDE, and Foundry with Chainstack Unichain nodes and endpoints."
---

Get started with a [reliable Unichain RPC endpoint](https://chainstack.com/build-better-with-unichain/) to use the tools below.
...
* NETWORK\_ID — Unichain network ID:
