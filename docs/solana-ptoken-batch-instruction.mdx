...
* The ~1,232-byte transaction size — each sub-instruction's header, data, and account references add up. This is the limit on a legacy or v0 transaction; [transaction v1](/docs/solana-transaction-v1) raises the envelope to 4,096 bytes.
