...
The Chainstack release notes are available as an RSS feed, allowing you to track product updates, new features, and important announcements automatically.
...
- [Release notes](/changelog) — view all Chainstack updates and announcements
- [Platform updates](https://chainstack.com/blog/) — read detailed blog posts about major releases
- [Status page](https://status.chainstack.com/) — monitor Chainstack service status