...
<Steps>
  <Step title="Adding capped supply and price fields">
  ...
  <Step title="Updating function calls">
...
<Step title="Enforcing capped supply and token price in minting">
...
<Steps>
  <Step title="Updating minter config">
  ...
  <Step title="Updating minting message">
...
<Steps>
  <Step title="Testing minting within capped supply">
...
<Step title="Testing minting above capped supply">
