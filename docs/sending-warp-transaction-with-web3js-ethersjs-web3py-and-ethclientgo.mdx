...
A Warp transaction is a type of transaction that is dispatched to your node using the [eth\_sendRawTransaction](/reference/ethereum_node_api/execute_transactions/eth_sendRawTransaction) RPC method. This method is a standard Ethereum procedure for transmitting transactions.
