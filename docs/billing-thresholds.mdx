...
<Info>
Billing thresholds apply to metered extra usage charges, including API requests, dedicated node hours, Warp transactions, and so on that exceed your plan's included allowances.
</Info>
