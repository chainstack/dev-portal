...
<Info>
  Check out [Covalent API magic: How to retrieve all transactions made by an account](/docs/tutorial-covalent-api-magic-how-to-retrieve-all-transactions-made-by-an-account) to see an example of how a real world application can use JWTs.
</Info>
