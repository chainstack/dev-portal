...
<Note>
  Subscription plan changes are not prorated. Upgrades are charged immediately for the new plan, and downgrades do not return unused funds to your balance. Prorated refunds for the unused portion of a billing cycle apply only to add-ons and Marketplace applications—see [Chainstack Marketplace billing details](#chainstack-marketplace-billing-details).
</Note>
