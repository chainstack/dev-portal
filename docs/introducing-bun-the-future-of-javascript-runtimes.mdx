...
* Sends a POST request to the Ethereum node to fetch the balance of the address using [eth\_getBalance](/reference/ethereum_node_api/accounts_info/eth_getBalance).
