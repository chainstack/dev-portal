...
description: "Complete Optimism RPC methods reference for Chainstack nodes. Access Ethereum-compatible JSON-RPC, debug, trace, and Erigon methods with availability status on Optimism."
---
