...
<Info>
  Check the details about the `eth_getBlockReceipts` response in the [Chainstack docs](/api-reference/ethereum_node_api/transaction_info/eth_getBlockReceipts).
</Info>
