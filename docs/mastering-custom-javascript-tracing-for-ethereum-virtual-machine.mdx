...
<Info>
  You can also find details about [built-in tracers](/reference/ethereum-debug-trace-rpc-methods#pre-built-javascript-based-tracers) and [custom tracing](/reference/ethereum_node_api/debug_and_trace/custom_js_tracer) in the Chainstack documentation.
</Info>
