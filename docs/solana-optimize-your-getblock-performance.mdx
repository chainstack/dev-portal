...
Solana's [getBlock](/reference/solana_node_api/getBlocks) RPC method is a fundamental method that can be tricky and will screw up your application performance in a jiffy if you are not paying attention.
