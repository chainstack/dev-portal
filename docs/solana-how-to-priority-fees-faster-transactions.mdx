...
<Info>
  In this example, the micro-lamport amount is arbitrary, but you can calculate it more dynamically using the **[getRecentPrioritizationFees](/reference/solana_node_api/getRecentPrioritizationFees)** method
</Info>
