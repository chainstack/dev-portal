...
<CardGroup>
  ...
  <Card title="How to mint a music NFT: Dropping fire tunes with Chainstack IPFS Storage" href="/docs/how-to-mint-music-nft-with-chainstack-ipfs-storage" icon="angle-right" horizontal />
  ...
  <Card title="How to mint a generative music NFT with Chainstack IPFS Storage and Soundraw" href="/docs/how-to-mint-generative-music-nft-with-chainstack-ipfs-storage-soundraw" icon="angle-right" horizontal />
