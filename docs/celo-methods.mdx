---
title: "Celo methods"
description: "Complete Celo RPC methods reference for Chainstack nodes. Access Ethereum-compatible JSON-RPC methods including eth_, net_, web3_ and Celo-specific methods with availability status."
---
