...
<Info>
  Check out the Docs to learn [how to generate your Chainstack API key](/api-reference/platform-api-getting-started#create-api-key).
</Info>
...
This example shows how to [retrieve the client version](/api-reference/ethereum_node_api/client_info/web3_clientVersion), one of the standard Ethereum JSON-RPC methods.
