...
This example shows how to [retrieve the client version](/reference/ethereum_node_api/client_info/web3_clientVersion), one of the standard Ethereum JSON-RPC methods.
