...
description: "AI agent runbook to migrate your project's blockchain RPC endpoints to Chainstack using the Chainstack MCP server with Claude, Codex, ChatGPT, Cursor, Windsurf, Pi agent, or just about any coding agent."
---
