...
Sui Global Nodes are [Extended](/docs/extended-nodes) — they serve checkpoint history from genesis, beyond the ~2 epochs (~48 hours) a standard Sui full node keeps locally.
