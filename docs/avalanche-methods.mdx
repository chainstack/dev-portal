...
<Note>
  This table reflects the C-Chain surface after the [Helicon upgrade](/docs/avalanche-helicon-upgrade), which removed the `admin`, `warp`, and `personal` namespaces, three `eth` methods, and eight non-trace `debug` methods. Helicon activated on Fuji Testnet on July 28, 2026 and activates on Avalanche Mainnet on September 22, 2026 at 15:00 UTC.
</Note>

| Method                                   | Availability | Comment |
| ---------------------------------------- | ------------ | ------- |
| eth\_accounts                            | <Icon icon="xmark"  iconType="solid" />            | Removed by the [Helicon upgrade](/docs/avalanche-helicon-upgrade) |
...
| debug\_getBadBlocks                      | <Icon icon="xmark"  iconType="solid" />            | Removed by the [Helicon upgrade](/docs/avalanche-helicon-upgrade) |
| debug\_storageRangeAt                    | <Icon icon="xmark"  iconType="solid" />            | Removed by the [Helicon upgrade](/docs/avalanche-helicon-upgrade) — use [eth\_getStorageAt instead](/docs/using-eth_getstorageat-instead-of-debug_storagerangeat-on-reth) |
