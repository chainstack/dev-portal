...
<Info>
  Find an example of the [logs filter](/reference/ethereum_node_api/logs_and_events/eth_newFilter) in the API reference.
</Info>
...
If you are trying to filter logs, instead of relying solely on filters, you can use the [eth\_getLogs](/reference/ethereum_node_api/logs_and_events/eth_getLogs) method to get historical data. This method is especially useful if you're interested in past events or transactions.
