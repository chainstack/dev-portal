---
title: "Blast methods"
description: "Complete Blast RPC methods reference for Chainstack nodes. Access Ethereum-compatible JSON-RPC methods including eth_, net_, web3_ with availability status on Blast blockchain."
---
