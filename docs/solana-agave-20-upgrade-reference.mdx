...
| --------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| confirmTransaction                | [getSignatureStatuses](/reference/solana_node_api/getSignatureStatuses)                                                                                                                                                          |
| getSignatureStatus                | [getSignatureStatuses](/reference/solana_node_api/getSignatureStatuses)                                                                                                                                                          |
| getSignatureConfirmation          | [getSignatureStatuses](/reference/solana_node_api/getSignatureStatuses)                                                                                                                                                          |
| getConfirmedSignaturesForAddress  | [getSignaturesForAddress](/reference/solana_node_api/getSignaturesForAddress)                                                                                                                                                    |
| getConfirmedBlock                 | [getBlock](/reference/solana_node_api/getBlocks)                                                                                                                                                                                  |
| getConfirmedBlocks                | [getBlocks](/reference/solana_node_api/getBlocks)                                                                                                                                                                                |
| getConfirmedBlocksWithLimit       | [getBlocksWithLimit](/reference/solana_node_api/getBlocksWithLimit)                                                                                                                                                                     |
| getConfirmedTransaction           | [getTransaction](/reference/solana_node_api/getTransaction)                                                                                                                                                                             |
| getConfirmedSignaturesForAddress2 | [getSignaturesForAddress](/reference/solana_node_api/getSignaturesForAddress)                                                                                                                                                    |
| getRecentBlockhash                | [getLatestBlockhash](/reference/solana_node_api/getLatestBlockhash)                                                                                                                                                              |
| getFees                           | [getFeeForMessage](/reference/solana_node_api/getFeeForMessage)                                                                                                                                                                  |
| getFeeCalculatorForBlockhash      | [isBlockhashValid](/reference/solana_node_api/isBlockhashValid) or [getFeeForMessage](/reference/solana_node_api/getFeeForMessage)                                                                                                               |
| getFeeRateGovernor                | [getFeeForMessage](/reference/solana_node_api/getFeeForMessage)                                                                                                                                                                  |
| getSnapshotSlot                   | [getHighestSnapshotSlot](/reference/solana_node_api/getHighestSnapshotSlot)                                                                                                                                                      |
| getStakeActivation                | [getAccountInfo \| Solana](/reference/solana_node_api/getAccountInfo) ([alternative approach](https://solana.stackexchange.com/questions/15710/the-alternative-method-to-get-the-stake-account-status-since-getstakeactivation)) |
