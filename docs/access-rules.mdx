...
<Steps>
  ...
  <Step>
    Enter the origin URL in the input field (e.g., `https://myapp.com`, or `https://myapp.example.com`, or `*.myapp.com`).
  </Step>
  <Step>
...
* **Specific domains**: `https://myapp.com`, `https://app.example.com`
...
<Info>
  Adding multiple origins or IP addresses is not supported. CIDR is not supported.
</Info>
...
Restrict access to specific server IP addresses:

```
IP address: 203.0.113.25
IP address: 203.0.113.26
```
