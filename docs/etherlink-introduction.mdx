...
description: "Learn about Etherlink EVM Layer 2 blockchain powered by Tezos Smart Rollups. Deploy dedicated nodes with Chainstack for fast, fair, and nearly free transactions."
---
