...
Base originally launched on the open-source, MIT-licensed [OP Stack](https://stack.optimism.io/), developed in collaboration with Optimism. With the Azul upgrade (mainnet May 28, 2026), Base made its first network upgrade independent of the OP Stack, while remaining fully EVM-compatible.
