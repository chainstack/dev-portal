...
**Kaia** — Kaia Mainnet and Kaia Kairos testnet are now available in full mode with Debug & Trace APIs enabled, providing developers with enhanced capabilities for smart contract development and debugging.
...
**Global Nodes** — Hoodi testnet is now available in archive mode with Debug & Trace APIs enabled, providing developers with enhanced capabilities for testing and debugging smart contracts.
