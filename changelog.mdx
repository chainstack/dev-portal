...
**Nodes**. Global Nodes now show an **Extended** label for Full nodes that keep more ledger history than a standard full node — more retention than Full, without being a complete Archive. It adds no pricing or request-unit change, initially on Sui, XRP Ledger, and Stellar.
