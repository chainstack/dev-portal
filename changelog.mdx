...
**Starknet**. Chainstack is upgrading Starknet nodes to [Pathfinder v0.24.0](https://github.com/equilibriumco/pathfinder/releases/tag/v0.24.0). This is a breaking change for WebSocket clients: a client that does not answer server-initiated pings is disconnected 60 seconds after its last frame, and a connection that sends nothing within 30 seconds of being established is closed. Standard WebSocket libraries answer pings automatically and need no changes.
