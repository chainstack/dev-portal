...
<Update label="Chainstack updates: September 19, 2026" description="">

**Protocols**. Solana [transaction v1](/docs/solana-transaction-v1) activated on Mainnet at the start of epoch 1035. Blocks now mix legacy, v0, and v1 transactions, and the per-transaction size limit is 4096 bytes instead of 1232. If you read Solana data, pass `maxSupportedTransactionVersion: 1` to [getBlock](/reference/solana-getblock), [getTransaction](/reference/gettransaction), and [blockSubscribe](/reference/blocksubscribe-solana).

<Button href="/changelog/chainstack-updates-september-19-2026">Read more</Button>
</Update>

<Update label="Chainstack updates: September 16, 2026" description=" by Ake">
...
**Nodes**. Global Nodes now show an **Extended** label for Full nodes that keep more ledger history than a standard full node — more retention than Full, without being a complete Archive. It adds no pricing or request-unit change.

<Button href="/changelog/chainstack-updates-september-16-2026">Read more</Button>
</Update>

<Update label="Chainstack updates: September 11, 2026" description=" by Vladimir">
...
<Button href="/changelog/chainstack-updates-september-11-2026">Read more</Button>
</Update>
