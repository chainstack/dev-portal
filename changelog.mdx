...
**Protocols**. Hyperliquid HyperEVM nodes are now in archive mode available with Debug & Trace methods and WebSocket support. See also [Hyperliquid methods](/docs/hyperliquid-methods) and [Hyperliquid API Reference](/reference/hyperliquid-getting-started).
