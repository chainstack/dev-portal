---
title: eth_getBlockReceipts | Arc
openapi: /openapi/arc_node_api/blocks_info/eth_getBlockReceipts.json POST /
description: "Arc API method that returns all transaction receipts for a given block. Reference for eth_getBlockReceipts on Arc via Chainstack."
---
