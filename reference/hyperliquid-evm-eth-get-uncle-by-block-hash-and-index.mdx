...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_eth_get_uncle_by_block_hash_and_index.json post /evm
description: "The eth_getUncleByBlockHashAndIndex JSON-RPC method returns information about an uncle block by block hash and uncle index position."
---
