...
description: "BNB API method used to remove a filter previously created using one of the following methods: eth_newFilter eth_newPendingTransactionFilter eth_newBlockFilter."
---
