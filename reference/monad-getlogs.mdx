...
description: "Monad API method that returns an array of all logs matching a given filter object. This is essential for tracking events emitted by smart contracts."
---
