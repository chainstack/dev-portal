...
description: "Subscribe to the Beacon Chain events and receive a stream of the following data: Event type (event: head): This specifies the type of event being streamed."
---
