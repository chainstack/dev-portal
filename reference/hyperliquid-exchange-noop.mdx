---
title: "noop | Hyperliquid exchange"
openapi: /openapi/hyperliquid_node_api/hypercore_exchange/exchange_noop.json post /exchange
description: "Performs a no-operation action. Useful for testing signature authentication or consuming rate limit weight without side effects. On Hyperliquid exchange."
---
...
Performs a no-operation action. Useful for testing signature authentication or consuming rate limit weight without side effects.
...
* **No-op** — Performs a no-operation action. Useful for testing signature authentication or consuming rate limit weight without side effects.
