...
description: "Base API method that retrieves the number of transactions in a block, identified by its hash. eth_getBlockTransactionCountByHash on Base via Chainstack."
---
