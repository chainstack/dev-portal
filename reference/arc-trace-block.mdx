---
title: trace_block | Arc
openapi: /openapi/arc_node_api/debug_and_trace/trace_block.json POST /
description: "Arc API method that returns execution traces for all transactions in a block. Reference for trace_block on Arc via Chainstack."
---
