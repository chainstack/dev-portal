---
title: eth_getBlockByNumber | Arc
openapi: /openapi/arc_node_api/blocks_info/eth_getBlockByNumber.json POST /
description: "Arc API method that returns information about a block specified by its number or tag. eth_getBlockByNumber on Arc via Chainstack."
---
