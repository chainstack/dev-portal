...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_debug_trace_transaction.json post /evm
description: "The debug_traceTransaction JSON-RPC method returns detailed trace information for a specific transaction. Hyperliquid EVM via Chainstack."
---
