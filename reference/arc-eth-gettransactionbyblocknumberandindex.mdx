---
title: eth_getTransactionByBlockNumberAndIndex | Arc
openapi: /openapi/arc_node_api/transaction_info/eth_getTransactionByBlockNumberAndIndex.json POST /
description: "Arc API method that returns information about a transaction by block number and transaction index position. Arc via Chainstack."
---

Arc API method that returns information about a transaction by block number and transaction index position.
