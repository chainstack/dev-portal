...
description: "Executes a call and retrieves a detailed execution trace of the call, similar to a transaction but without. debug_traceCall on Optimism via Chainstack."
---
