...
description: "TRON API method that creates parameters for a shielded TRC20 contract transaction. wallet/createshieldedcontractparameters on TRON via Chainstack."
---
