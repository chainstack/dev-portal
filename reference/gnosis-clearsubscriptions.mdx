...
description: "Unsubscribe from all active Gnosis Chain ethers.js subscriptions at once using removeAllListeners. Useful for cleanup when resetting your event listeners."
---
...
`boolean` — keep the [eth_syncing](/reference/gnosis-subscribesyncing) subscription if `true`.
