...
description: "Unsubscribe from all active Gnosis Chain web3.js subscriptions at once using clearSubscriptions. Useful for cleanup when resetting your event listeners."
---
