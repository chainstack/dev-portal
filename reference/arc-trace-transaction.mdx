---
title: trace_transaction | Arc
openapi: /openapi/arc_node_api/debug_and_trace/trace_transaction.json POST /
description: "Arc API method that returns execution traces for a specific transaction. Reference for trace_transaction on Arc via Chainstack."
---
