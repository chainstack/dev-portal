---
title: "Fantom API reference: Lachesis DAG JSON-RPC quickstart"
description: "Use the Fantom JSON-RPC API on Chainstack to deploy nodes, send transactions, and build on the EVM-compatible Lachesis DAG blockchain."
---
