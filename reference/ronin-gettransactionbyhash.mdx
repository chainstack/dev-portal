...
description: "Ronin API method that returns information about a transaction by its hash. This includes details such as the transaction's sender and receiver."
---
