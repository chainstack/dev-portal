...
description: "Query the Beacon Chain fork version and epoch for any state using the eth/v1/beacon/states/{state_id}/fork endpoint to track consensus layer upgrades."
---
