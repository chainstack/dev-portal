...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_eth_call_many.json post /evm
description: "The eth_callMany JSON-RPC method executes multiple call transactions in sequence without creating transactions on the blockchain. On Hyperliquid EVM."
---
