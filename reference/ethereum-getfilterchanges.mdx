...
description: "Ethereum API polling method used to retrieve updates from a filter. A filter is an object used to track changes to the state of the blockchain."
---
