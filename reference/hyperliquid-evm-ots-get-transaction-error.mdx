...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_ots_get_transaction_error.json post /evm
description: "The ots_getTransactionError JSON-RPC method retrieves the raw revert reason for failed transactions on the Hyperliquid EVM blockchain."
---
