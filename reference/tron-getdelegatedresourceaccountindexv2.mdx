...
description: "Reference docs for the wallet/getdelegatedresourceaccountindexv2 JSON-RPC method on the TRON blockchain, available via Chainstack JSON-RPC nodes."
---
