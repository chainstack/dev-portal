---
title: trace_replayBlockTransactions | Arc
openapi: /openapi/arc_node_api/debug_and_trace/trace_replayBlockTransactions.json POST /
description: "Arc API method that replays all transactions in a block and returns execution traces for each. Available on Arc via Chainstack."
---
