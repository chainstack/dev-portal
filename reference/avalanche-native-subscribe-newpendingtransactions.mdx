...
description: "Subscribe to pending Avalanche transactions via WebSocket. Receive real-time notifications when new unconfirmed transactions enter the mempool."
---
