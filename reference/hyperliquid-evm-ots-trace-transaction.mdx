...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_ots_trace_transaction.json post /evm
description: "The ots_traceTransaction JSON-RPC method returns the complete execution trace of a transaction on the Hyperliquid EVM blockchain. On Hyperliquid EVM."
---
