...
openapi: /openapi/hyperliquid_node_api/hypercore_info/info_user_fills_by_time.json post /info
description: "The info endpoint with type: \"userFillsByTime\" retrieves a user's trading fills (executed orders) within a specific time range on the Hyperliquid exchange."
---
