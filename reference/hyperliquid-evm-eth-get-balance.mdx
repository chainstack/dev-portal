...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_eth_get_balance.json post /evm
description: "The eth_getBalance JSON-RPC method returns the balance of an account at a given block number. Chainstack Hyperliquid EVM reference."
---
