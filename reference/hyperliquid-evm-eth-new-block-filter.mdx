...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_eth_new_block_filter.json post /evm
description: "The eth_newBlockFilter JSON-RPC method creates a filter object to notify when new blocks arrive on the blockchain. On Hyperliquid EVM."
---
