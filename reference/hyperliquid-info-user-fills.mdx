...
openapi: /openapi/hyperliquid_node_api/hypercore_info/info_user_fills.json post /info
description: "The info endpoint with type: \"userFills\" retrieves a user's trading fills (executed orders) on the Hyperliquid exchange. On Hyperliquid info."
---
