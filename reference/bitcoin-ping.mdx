...
description: "The ping method is used to send a ping to all connected peers to ensure they are active. Available on Bitcoin via Chainstack JSON-RPC nodes."
---
