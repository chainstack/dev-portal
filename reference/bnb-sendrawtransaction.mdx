...
description: "BNB API method that allows submitting a signed transaction to the network. Reference for eth_sendRawTransaction on BNB Chain via Chainstack."
---
