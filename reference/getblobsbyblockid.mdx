...
description: "The /eth/v1/beacon/blobs/{block_id} method retrieves information about blobs by block ID. Retrieve blobs by block ID on Chainstack via Chainstack."
---
