...
openapi: /openapi/hyperliquid_node_api/hypercore_info/info_user_funding.json post /info
description: "The info endpoint with type: \"userFunding\" retrieves the funding history for a specific user account on the Hyperliquid exchange. On Hyperliquid info."
---
