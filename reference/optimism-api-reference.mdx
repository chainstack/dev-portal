---
title: "Optimism API reference: op-reth JSON-RPC"
description: "Optimism API reference for Chainstack nodes — Global and Trader nodes both run op-reth. Covers the supported JSON-RPC methods and namespaces."
---
