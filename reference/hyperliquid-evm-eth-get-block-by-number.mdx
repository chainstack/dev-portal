...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_eth_get_block_by_number.json post /evm
description: "The eth_getBlockByNumber JSON-RPC method returns information about a block by its number. Use it on Hyperliquid EVM via Chainstack."
---
