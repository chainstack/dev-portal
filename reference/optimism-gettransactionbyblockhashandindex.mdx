...
description: "Reference docs for the eth_getTransactionByBlockHashAndIndex JSON-RPC method on the Optimism blockchain, available via Chainstack JSON-RPC nodes."
---
