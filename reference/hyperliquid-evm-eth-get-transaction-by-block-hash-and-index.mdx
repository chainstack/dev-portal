...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_eth_get_transaction_by_block_hash_and_index.json post /evm
description: "The eth_getTransactionByBlockHashAndIndex JSON-RPC method returns transaction information by block hash and transaction index. On Hyperliquid EVM."
---
