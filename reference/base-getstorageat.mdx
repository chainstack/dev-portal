...
description: "Base API method eth_getStorageAt retrieves the value from a specific storage position of a contract at a given address. Base via Chainstack."
---
