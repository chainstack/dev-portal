...
description: "Subscribe to real-time Solana account changes with accountSubscribe. Receive WebSocket notifications whenever a monitored account is modified."
---
