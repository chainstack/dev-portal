...
description: "Cancel any active Optimism WebSocket subscription with eth_unsubscribe. Pass the subscription ID to stop receiving real-time event notifications."
---
