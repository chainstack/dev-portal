...
<CardGroup>
<Card title="eth_subscribe('logs')" href="/reference/optimism_node_api/eth_subscribelogs" icon="angle-right" iconType="solid" horizontal />
<Card title="eth_subscribe('newHeads')" href="/reference/optimism_node_api/eth_subscribenewHeads" icon="angle-right" iconType="solid" horizontal />
</CardGroup>
