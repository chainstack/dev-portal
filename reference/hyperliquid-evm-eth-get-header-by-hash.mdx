...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_eth_get_header_by_hash.json post /evm
description: "The eth_getHeaderByHash JSON-RPC method returns the block header information for a given block hash. Hyperliquid EVM via Chainstack."
---
