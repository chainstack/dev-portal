---
title: "eth_maxPriorityFeePerGas | Robinhood"
openapi: /openapi/robinhood_node_api/gas_data/eth_maxPriorityFeePerGas.json POST /
description: "Robinhood Chain API method that returns the current max priority fee per gas in Wei. Reference for eth_maxPriorityFeePerGas on Robinhood Chain via Chainstack."
---
