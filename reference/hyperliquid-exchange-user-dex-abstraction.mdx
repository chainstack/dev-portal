...
openapi: /openapi/hyperliquid_node_api/hypercore_exchange/exchange_user_dex_abstraction.json post /exchange
description: "Sets the user's DEX abstraction configuration for perp DEX routing. This is being deprecated in favor of the unified account system."
---
