...
description: "Optimism API method that retrieves the number of uncles in a block, identified by its hash. eth_getUncleCountByBlockHash on Optimism via Chainstack."
---
