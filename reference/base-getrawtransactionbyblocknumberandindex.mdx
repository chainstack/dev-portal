...
description: "Base API method eth_getRawTransactionByBlockNumberAndIndex retrieves the raw transaction data as a hexadecimal string for a transaction in a specific block."
---
