...
description: "TRON API method that generates a complete new shielded address with all necessary keys for shielded TRC20 transactions. TRON via Chainstack."
---
