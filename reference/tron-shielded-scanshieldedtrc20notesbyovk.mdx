...
description: "TRON API method that scans for shielded TRC20 notes using an outgoing viewing key (ovk). wallet/scanshieldedtrc20notesbyovk on TRON via Chainstack."
---
