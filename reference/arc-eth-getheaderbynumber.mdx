---
title: eth_getHeaderByNumber | Arc
openapi: /openapi/arc_node_api/blocks_info/eth_getHeaderByNumber.json POST /
description: "Arc API method that returns the block header by block number. quantity or tag — the block number in hex format or block tag (latest, earliest, pending."
---
