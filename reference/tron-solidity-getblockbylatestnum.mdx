...
description: "TRON API method that retrieves the latest solidified blocks by specifying a count. walletsolidity/getblockbylatestnum on TRON via Chainstack."
---
