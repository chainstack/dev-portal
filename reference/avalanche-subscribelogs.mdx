...
description: "Reference for the subscribe (\"logs\") JSON-RPC method on the Avalanche blockchain via Chainstack nodes. Parameters, response, and examples included."
---
