...
description: "The debug_getModifiedAccountsByHash RPC method retrieves a list of accounts that were modified in. debug_getModifiedAccountsByHash on Optimism via Chainstack."
---
