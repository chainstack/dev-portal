...
description: "Monad API method that returns the number of transactions sent from an address. Reference for eth_getTransactionCount on Monad via Chainstack."
---
