...
description: "Subscribe to new Polygon block headers via WebSocket. Receive real-time notifications whenever a new block is added to the Polygon PoS blockchain."
---
