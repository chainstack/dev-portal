...
* `object`— a block object with the following fields:
  ...
  * `transactions` — an array of transaction objects. See [eth\_getTransactionByHash](/reference/polygon_node_api/transaction_info/eth_getTransactionByHash) for the exact shape.
