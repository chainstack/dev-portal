...
description: "Subscribe to real-time changes for all accounts owned by a Solana program using programSubscribe. Get WebSocket updates on program account modifications."
---
