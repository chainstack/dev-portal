---
title: ots_getBlockDetailsByHash | Hyperliquid EVM
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_ots_get_block_details_by_hash.json post /evm
description: "The ots_getBlockDetailsByHash JSON-RPC method retrieves expanded block details by block hash on the Hyperliquid EVM blockchain. On Hyperliquid EVM."
---
