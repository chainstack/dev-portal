...
description: "Reference docs for the Debug beacon state by state_id JSON-RPC method on the Chainstack blockchain, available via Chainstack JSON-RPC nodes."
---
