...
description: "zkSync Era API method that returns the address of the testnet paymaster. Reference for zks_getTestnetPaymaster on zkSync Era via Chainstack."
---
