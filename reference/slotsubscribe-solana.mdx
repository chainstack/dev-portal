...
description: "Subscribe to Solana slot updates with slotSubscribe. Receive real-time WebSocket notifications whenever the validator processes a new slot on the network."
---
