...
<CardGroup cols={2}>
  <Card title="eth_chainId" icon="angle-right" iconType="solid" href="/reference/ethereum_node_api/chain_info/eth_chainId" horizontal/>
  <Card title="eth_syncing" icon="angle-right" iconType="solid" href="/reference/ethereum_node_api/chain_info/eth_syncing" horizontal/>
</CardGroup>
