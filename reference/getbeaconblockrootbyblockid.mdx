...
description: "The /eth/v1/beacon/blocks/{block_id}/root method is a specific API endpoint in the Ethereum Beacon Chain that provides the root of a given beacon block."
---
