...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_eth_get_transaction_by_block_number_and_index.json post /evm
description: "The eth_getTransactionByBlockNumberAndIndex JSON-RPC method returns transaction information by block number and transaction index."
---
