...
description: "Reference for the Custom JS tracer JSON-RPC method on the Fantom blockchain via Chainstack nodes. Parameters, response, and examples included."
---
