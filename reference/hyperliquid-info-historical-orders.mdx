...
openapi: /openapi/hyperliquid_node_api/hypercore_info/info_historical_orders.json post /info
description: "The info endpoint with type: \"historicalOrders\" retrieves a user's historical orders on the Hyperliquid exchange. On Hyperliquid info."
---
