...
description: "Subscribe to new Ronin block headers via WebSocket. Receive real-time notifications whenever a new block is added to the Ronin blockchain network."
---
