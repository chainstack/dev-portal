---
title: "Gnosis Chain API reference: xDai sidechain JSON-RPC"
description: "Use the Gnosis Chain JSON-RPC and Beacon APIs on Chainstack to query the xDai EVM sidechain, send transactions, and access consensus layer data."
---
