...
description: "Subscribe to new Optimism block headers via WebSocket. Receive real-time notifications whenever a new block is added to the Optimism blockchain."
---
