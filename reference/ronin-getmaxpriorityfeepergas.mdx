...
description: "The eth_maxPriorityFeePerGas method returns the current maximum priority fee per gas in wei. eth_maxPriorityFeePerGas on Ronin via Chainstack."
---
