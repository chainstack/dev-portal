...
description: "Plasma API method that executes the given call and returns execution traces. object — the transaction call object array — array of trace types (trace."
---
