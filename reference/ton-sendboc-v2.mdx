...
description: "The sendBoc method sends a serialized bag-of-cells (BoC) to the TON blockchain. This is the primary method for submitting signed transactions to the network."
---
