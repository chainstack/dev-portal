...
description: "Tempo API method that funds an address with testnet stablecoins. tempo_fundAddress JSON-RPC method available on the Tempo blockchain via Chainstack."
---
