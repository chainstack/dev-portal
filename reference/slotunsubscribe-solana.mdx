...
description: "Cancel a Solana slot subscription with slotUnsubscribe. Stop receiving real-time WebSocket notifications for slot processing updates from the node."
---
