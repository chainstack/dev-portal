...
description: "Subscribe to new Avalanche block headers via WebSocket. Receive real-time notifications whenever a new block is added to the Avalanche C-Chain."
---
