...
description: "Base API method web3_sha3 computes the Keccak-256 hash of the given data. web3_sha3 JSON-RPC method available on the Base blockchain via Chainstack."
---
