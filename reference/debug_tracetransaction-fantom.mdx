...
description: "Fantom debug_traceTransaction method — replay a transaction to get a step-by-step execution trace with opcodes, gas usage, and state change details."
---
