...
openapi: /openapi/hyperliquid_node_api/hypercore_info/info_max_builder_fee.json post /4f8d8f4040bdacd1577bff8058438274/info
description: "The info endpoint with type: \"maxBuilderFee\" retrieves the maximum builder fee that a user has approved for a specific builder on the Hyperliquid network."
---
