...
description: "Starknet API method that returns the nonce for a given account. starknet_getNonce JSON-RPC method available on the Starknet blockchain via Chainstack."
---
