...
description: "Cancel any active Ronin WebSocket subscription with eth_unsubscribe. Pass the subscription ID to stop receiving real-time blockchain event notifications."
---
