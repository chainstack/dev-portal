...
openapi: /openapi/hyperliquid_node_api/hypercore_exchange/exchange_usd_send.json post /exchange
description: "Transfers USDC directly to another address on the Hyperliquid chain. Available on Hyperliquid exchange via Chainstack JSON-RPC nodes."
---
