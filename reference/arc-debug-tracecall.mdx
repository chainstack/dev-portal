---
title: debug_traceCall | Arc
openapi: /openapi/arc_node_api/debug_and_trace/debug_traceCall.json POST /
description: "Arc API method that traces the execution of a call without creating a transaction on the blockchain. Chainstack Arc reference."
---
