...
openapi: /openapi/hyperliquid_node_api/hypercore_info/info_user_to_multi_sig_signers.json post /4f8d8f4040bdacd1577bff8058438274/info
description: "The info endpoint with type: \"userToMultiSigSigners\" retrieves the list of multi-signature signers associated with a specific user on the Hyperliquid network."
---
