...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_net_listening.json post /evm
description: "The net_listening JSON-RPC method returns true if the client is actively listening for network connections. Hyperliquid EVM via Chainstack."
---
