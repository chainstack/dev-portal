...
description: "Fantom API method that returns information about a transaction from its hash. It is used to retrieve information about a specific transaction by its hash."
---
