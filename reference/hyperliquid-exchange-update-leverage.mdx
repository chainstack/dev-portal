...
openapi: /openapi/hyperliquid_node_api/hypercore_exchange/exchange_update_leverage.json post /exchange
description: "Updates the leverage setting for a specific coin on the Hyperliquid exchange. You can adjust leverage for both cross and isolated margin modes."
---
