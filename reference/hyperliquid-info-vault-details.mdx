...
openapi: /openapi/hyperliquid_node_api/hypercore_info/info_vault_details.json post /info
description: "The info endpoint with type: \"vaultDetails\" retrieves comprehensive information about a specific vault on the Hyperliquid exchange."
---
