---
title: eth_newBlockFilter | Arc
openapi: /openapi/arc_node_api/filter_handling/eth_newBlockFilter.json POST /
description: "Arc API method that creates a filter for new block notifications. The filter can be polled with eth_getFilterChanges to get new block hashes."
---
