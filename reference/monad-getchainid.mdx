...
description: "Monad API method that returns the chain ID of the current network. eth_chainId JSON-RPC method available on the Monad blockchain via Chainstack."
---
