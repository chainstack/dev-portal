...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_eth_call.json post /evm
description: "The eth_call JSON-RPC method executes a new message call immediately without creating a transaction on the blockchain. On Hyperliquid EVM."
---
