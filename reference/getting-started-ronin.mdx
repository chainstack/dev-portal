---
title: "Ronin API reference: Axie Infinity EVM JSON-RPC"
description: "Use the Ronin JSON-RPC API on Chainstack to deploy nodes, send transactions, and build games on the Axie Infinity EVM chain by Sky Mavis."
---
