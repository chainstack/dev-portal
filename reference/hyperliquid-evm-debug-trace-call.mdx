...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_debug_trace_call.json post /evm
description: "The debug_traceCall JSON-RPC method executes a call and returns detailed trace information without creating a transaction. On Hyperliquid EVM."
---
