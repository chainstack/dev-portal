---
title: "Plasma API reference: Reth-based EVM JSON-RPC quickstart"
description: "Use the Plasma JSON-RPC API on Chainstack to deploy nodes, send transactions, and build on the Reth-powered EVM-compatible Ethereum sidechain."
---
