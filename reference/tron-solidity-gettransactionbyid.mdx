...
description: "TRON API method that retrieves transaction details by transaction ID from solidified blocks. walletsolidity/gettransactionbyid on TRON via Chainstack."
---
