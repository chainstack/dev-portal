...
description: "Cancel any active Gnosis Chain WebSocket subscription with eth_unsubscribe. Pass the subscription ID to stop receiving real-time event notifications."
---
