---
title: eth_feeHistory | Arc
openapi: /openapi/arc_node_api/gas_data/eth_feeHistory.json POST /
description: "Arc API method that returns historical gas information for a range of blocks. Reference for eth_feeHistory on Arc via Chainstack."
---
