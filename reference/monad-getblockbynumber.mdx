...
description: "Monad API method that returns information about a block by block number. This method allows you to retrieve detailed information about a specific block."
---
