...
description: "TRON API method that removes liquidity from an existing exchange trading pair on the TRON decentralized exchange. Returns a transaction object containing:."
---
