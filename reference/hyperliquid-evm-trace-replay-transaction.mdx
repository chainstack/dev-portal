...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_trace_replay_transaction.json post /evm
description: "The trace_replayTransaction JSON-RPC method replays a specific transaction and returns trace information. Hyperliquid EVM via Chainstack."
---
