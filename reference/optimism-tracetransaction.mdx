...
description: "The debug_traceTransaction RPC method retrieves a detailed execution trace of a transaction, identified by. debug_traceTransaction on Optimism via Chainstack."
---
