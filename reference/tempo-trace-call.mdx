...
description: "Tempo API method that traces a call without creating a transaction. This provides detailed execution traces using the Parity/OpenEthereum trace format."
---
