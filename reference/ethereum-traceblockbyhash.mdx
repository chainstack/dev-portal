...
description: "Ethereum API method that traces the execution of a block. debug_traceBlockByHash JSON-RPC method available on the Ethereum blockchain via Chainstack."
---
