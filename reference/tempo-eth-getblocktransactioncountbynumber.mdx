...
description: "Tempo API method that returns the number of transactions in a block specified by block number. eth_getBlockTransactionCountByNumber on Tempo via Chainstack."
---
