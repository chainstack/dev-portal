...
* [eth\_newFilter | Optimism](/api-reference/polygon_node_api/logs_and_events/eth_newFilter)
* [eth\_newBlockFilter | Optimism](/api-reference/optimism_node_api/eth_newBlockFilter)
