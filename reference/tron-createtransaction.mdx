...
description: "TRON API method that creates an unsigned TRX transfer transaction. This method generates a transaction object that transfers TRX from one address to another."
---
