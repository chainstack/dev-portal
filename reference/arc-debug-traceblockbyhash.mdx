---
title: debug_traceBlockByHash | Arc
openapi: /openapi/arc_node_api/debug_and_trace/debug_traceBlockByHash.json POST /
description: "Arc API method that returns detailed traces for all transactions in a block specified by block hash. Chainstack Arc reference."
---
...
traceBlockByHash("0xa86891cc8ae2e3efe67b21e24f8f852e76a0875892e9e8c9a4c77aab8e2761cc");
```
...
curl -X POST "CHAINSTACK_NODE_URL" \
  ...
  -d '{
    ...
    "params": ["0xa86891cc8ae2e3efe67b21e24f8f852e76a0875892e9e8c9a4c77aab8e2761cc", {"tracer": "callTracer"}],
    "id": 1
  }'
```
</CodeGroup>
