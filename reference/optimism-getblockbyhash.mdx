...
description: "Optimism API method that retrieves a block's information by its hash. The block hash is a unique identifier for each block in the blockchain."
---
