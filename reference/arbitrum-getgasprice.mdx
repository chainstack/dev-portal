...
description: "Arbitrum API method that returns the current gas base fee of the network. Arbitrum developers can call eth_gasPrice via Chainstack."
---
