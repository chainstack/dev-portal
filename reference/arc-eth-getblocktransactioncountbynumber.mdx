---
title: eth_getBlockTransactionCountByNumber | Arc
openapi: /openapi/arc_node_api/blocks_info/eth_getBlockTransactionCountByNumber.json POST /
description: "Arc API method that returns the number of transactions in a block specified by block number. eth_getBlockTransactionCountByNumber on Arc via Chainstack."
---

Arc API method that returns the number of transactions in a block specified by block number.
