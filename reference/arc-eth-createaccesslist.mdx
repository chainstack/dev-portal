---
title: eth_createAccessList | Arc
openapi: /openapi/arc_node_api/execute_transactions/eth_createAccessList.json POST /
description: "Arc API method that creates an EIP-2930 access list for a transaction. The access list identifies storage slots and addresses the transaction will access."
---
...
curl -X POST "CHAINSTACK_NODE_URL" \
  ...
  -d '{"jsonrpc": "2.0", "method": "eth_createAccessList", "params": [{"to": "0x3600000000000000000000000000000000000000", "data": "0x95d89b41"}, "latest"], "id": 1}'
```
</CodeGroup>
