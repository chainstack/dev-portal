...
description: "Cronos API method that returns the number of transactions in a block specified by block number or tag. This information can be useful for analytics purposes."
---
