...
openapi: /openapi/hyperliquid_node_api/hypercore_info/info_l2_book.json post /info
description: "The info endpoint with type: \"l2Book\" retrieves a Level 2 order book snapshot for a specific asset on the Hyperliquid exchange. On Hyperliquid info."
---
