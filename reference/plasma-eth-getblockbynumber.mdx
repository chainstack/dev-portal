---
title: eth_getBlockByNumber | Plasma
openapi: /openapi/plasma_node_api/blocks_info/eth_getBlockByNumber.json POST /be84184cd12967be5a65d06651c60085
description: "Plasma API method that returns information about a block by block number. quantity or tag — the block number in hex format or block tag (latest, earliest."
---
