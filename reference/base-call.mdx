...
description: "The example is a call to the balanceOf method on the USDC contract. eth_call JSON-RPC method available on the Base blockchain via Chainstack."
---
