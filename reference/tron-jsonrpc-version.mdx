...
description: "TRON net_version JSON-RPC method — retrieve the current TRON network ID for chain identification via the Ethereum-compatible JSON-RPC interface on Chainstack."
