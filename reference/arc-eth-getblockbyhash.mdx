---
title: eth_getBlockByHash | Arc
openapi: /openapi/arc_node_api/blocks_info/eth_getBlockByHash.json POST /
description: "Arc API method that returns information about a block specified by its hash. Reference for eth_getBlockByHash on Arc via Chainstack."
---
