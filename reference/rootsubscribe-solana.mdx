...
description: "Subscribe to Solana ledger root changes with rootSubscribe. Receive real-time WebSocket notifications whenever the validator confirms a new root slot."
---
