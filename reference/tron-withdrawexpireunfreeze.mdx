...
description: "TRON API method that withdraws TRX tokens that have completed the unstaking waiting period. wallet/withdrawexpireunfreeze on TRON via Chainstack."
---
