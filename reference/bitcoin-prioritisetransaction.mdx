...
description: "Reference for the prioritisetransaction JSON-RPC method on the Bitcoin blockchain via Chainstack nodes. Parameters, response, and examples included."
---
