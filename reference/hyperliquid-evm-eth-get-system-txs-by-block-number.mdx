...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_eth_get_system_txs_by_block_number.json post /evm
description: "The eth_getSystemTxsByBlockNumber JSON-RPC method returns system transactions for a given block number on Hyperliquid EVM. On Hyperliquid EVM."
---
