...
description: "Base API method that returns the protocol version of the node. eth_protocolVersion JSON-RPC method available on the Base blockchain via Chainstack."
---
