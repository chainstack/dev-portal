...
openapi: /openapi/hyperliquid_node_api/hypercore_exchange/exchange_cancel_by_cloid.json post /exchange
description: "Cancels one or multiple open orders by client order ID (cloid) on the Hyperliquid exchange. Chainstack Hyperliquid exchange reference."
---
