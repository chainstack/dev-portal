...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_eth_get_filter_changes.json post /evm
description: "The eth_getFilterChanges JSON-RPC method returns an array of logs or block hashes that have occurred since the last poll for the specified filter."
---
