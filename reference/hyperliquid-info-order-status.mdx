...
openapi: /openapi/hyperliquid_node_api/hypercore_info/info_order_status.json post /info
description: "The info endpoint with type: \"orderStatus\" retrieves the current status and details of a specific order on the Hyperliquid exchange."
---
