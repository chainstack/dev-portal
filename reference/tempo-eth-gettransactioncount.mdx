...
description: "Tempo API method that returns the number of transactions sent from an address (the nonce). This is used to set the correct nonce when sending transactions."
---
