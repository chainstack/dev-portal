...
description: "TRON API method that retrieves detailed information about a specific exchange trading pair by its unique identifier. Returns an exchange object containing:."
---
