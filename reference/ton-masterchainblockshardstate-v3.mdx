...
description: "The masterchainBlockShardState method retrieves the shard state of a specific masterchain block in the TON blockchain. TON v3 via Chainstack."
---
