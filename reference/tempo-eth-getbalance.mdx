...
description: "Tempo API method that returns the balance of an account. address — the address to check balance for blockParameter — the block number (hex) or tag (latest."
---
