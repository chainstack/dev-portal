...
description: "The Solana getBlocks method returns a list of confirmed blocks within a specified slot range. Available on Solana via Chainstack JSON-RPC nodes."
---
