...
description: "Base API method that retrieves a block's information by its number. The block number is a sequential identifier for each block in the blockchain."
---
