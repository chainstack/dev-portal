...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_eth_create_access_list.json post /evm
description: "The eth_createAccessList JSON-RPC method generates an access list for a transaction. eth_createAccessList on Hyperliquid EVM via Chainstack."
---
