...
description: "Base API method that returns a list of addresses owned by the client. eth_accounts JSON-RPC method available on the Base blockchain via Chainstack."
---
