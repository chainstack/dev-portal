...
description: "Reference docs for the eth_newPendingTransactionFilter JSON-RPC method on the Avalanche blockchain, available via Chainstack JSON-RPC nodes."
---
