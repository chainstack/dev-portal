...
description: "TRON API method that delegates resources to another account. wallet/delegateresource JSON-RPC method available on the TRON blockchain via Chainstack."
---
