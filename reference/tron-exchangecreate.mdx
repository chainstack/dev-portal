...
description: "TRON API method that creates a new trading pair on the TRON decentralized exchange with initial liquidity provision. Returns a transaction object containing:."
---
