---
title: "twapOrder | Hyperliquid exchange"
openapi: /openapi/hyperliquid_node_api/hypercore_exchange/exchange_twap_order.json post /exchange
description: "Places a TWAP (Time-Weighted Average Price) order that splits a large order into smaller slices executed over a specified duration."
---
...
Places a TWAP (Time-Weighted Average Price) order that splits a large order into smaller slices executed over a specified duration.
...
* **TWAP order** — Places a TWAP (Time-Weighted Average Price) order that splits a large order into smaller slices executed over a specified duration.
