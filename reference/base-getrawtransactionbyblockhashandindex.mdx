...
description: "Base API method eth_getRawTransactionByBlockHashAndIndex retrieves the raw transaction data as a hexadecimal string for a transaction in a specific block."
---
