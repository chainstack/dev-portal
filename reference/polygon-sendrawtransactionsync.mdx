...
description: "Polygon API method that submits a signed transaction and blocks until the transaction receipt is returned or the timeout expires. On Polygon."
---
