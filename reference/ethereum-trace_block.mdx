...
description: "Ethereum API method that returns traces for all the transactions within a specific block. Available on Ethereum via Chainstack JSON-RPC nodes."
---
