...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_trace_call_many.json post /evm
description: "The trace_callMany JSON-RPC method executes multiple calls and returns trace information for each call. Hyperliquid EVM via Chainstack."
---
