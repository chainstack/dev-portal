...
description: "Arbitrum API method that returns the preimage for a given Keccak-256 hash. In Ethereum's state trie, account addresses are stored as their Keccak-256 hashes."
---
