---
title: "Polygon API reference: PoS sidechain JSON-RPC quickstart"
description: "Use the Polygon JSON-RPC API on Chainstack to deploy nodes, send transactions, bridge assets, and build on the EVM-compatible PoS sidechain."
---
