---
title: "cDeposit | Hyperliquid exchange"
openapi: /openapi/hyperliquid_node_api/hypercore_exchange/exchange_c_deposit.json post /exchange
description: "Deposits tokens into the consensus layer for staking or validator operations. Available on Hyperliquid exchange via Chainstack JSON-RPC nodes."
---
...
Deposits tokens into the consensus layer for staking or validator operations.
...
* **C deposit** — Deposits tokens into the consensus layer for staking or validator operations.
