...
description: "TRON API method that updates an account's name on the TRON blockchain. This method creates an unsigned transaction to set or modify the account name field."
---
