...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_eth_gas_price.json post /evm
description: "The eth_gasPrice JSON-RPC method returns the base fee for the next small block on Hyperliquid EVM. Hyperliquid EVM via Chainstack."
---
