...
* `object` — a block object, or `null` when no block was found.
  ...
  + `transactions` — array of transaction objects. See [eth\_getTransactionByHash](/api-reference/arbitrum_node_api/transaction_info/eth_getTransactionByHash) for the exact shape.
