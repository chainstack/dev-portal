...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_eth_get_code.json post /evm
description: "The eth_getCode JSON-RPC method returns the bytecode of a smart contract at a given address and block. Hyperliquid EVM via Chainstack."
---
