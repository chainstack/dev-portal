...
description: "TRON API method that creates a transaction to cancel an existing market order on the TRON DEX. wallet/marketcancelorder on TRON via Chainstack."
---
