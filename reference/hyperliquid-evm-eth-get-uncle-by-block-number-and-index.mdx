...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_eth_get_uncle_by_block_number_and_index.json post /evm
description: "The eth_getUncleByBlockNumberAndIndex JSON-RPC method returns information about an uncle block by block number and uncle index position."
---
