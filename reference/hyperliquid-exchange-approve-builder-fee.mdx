---
title: "approveBuilderFee | Hyperliquid exchange"
openapi: /openapi/hyperliquid_node_api/hypercore_exchange/exchange_approve_builder_fee.json post /exchange
description: "Approves a builder fee for a specific builder address. This allows the builder to charge fees on orders placed through their interface."
---
