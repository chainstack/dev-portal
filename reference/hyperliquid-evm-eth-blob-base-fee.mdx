...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_eth_blob_base_fee.json post /evm
description: "The eth_blobBaseFee JSON-RPC method returns the current base fee for blob transactions on the Hyperliquid EVM blockchain. On Hyperliquid EVM."
---
