...
description: "TRON API method that validates whether a given address is a valid TRON address. Reference for wallet/validateaddress on TRON via Chainstack."
---
