...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_net_peer_count.json post /evm
description: "The net_peerCount JSON-RPC method returns the number of peers currently connected to the client. Chainstack Hyperliquid EVM reference."
---
