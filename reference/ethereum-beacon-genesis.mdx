---
title: "Genesis data"
description: "Retrieve the Ethereum Beacon Chain genesis state with the eth/v1/beacon/genesis endpoint, including genesis time, validators root, and fork version."
