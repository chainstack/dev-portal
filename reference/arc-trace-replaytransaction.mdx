---
title: trace_replayTransaction | Arc
openapi: /openapi/arc_node_api/debug_and_trace/trace_replayTransaction.json POST /
description: "Arc API method that replays a specific transaction and returns detailed execution traces. trace_replayTransaction on Arc via Chainstack."
---
