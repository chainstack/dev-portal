...
description: "Monad API method that returns the current client version. This method is useful for identifying the node implementation and version you are connected to."
---
