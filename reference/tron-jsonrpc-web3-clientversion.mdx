...
description: "TRON API method that returns the client version using Ethereum-compatible JSON-RPC format. jsonrpc web3_clientVersion on TRON via Chainstack."
---
