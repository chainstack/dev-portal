...
* `array` — the array of 32-byte storage keys that need to be proven and included. See [eth\_getStorageAt](/reference/ethereum_node_api/accounts_info/eth_getStorageAt).
...
* `balance` — represents the account balance. Refer to [eth\_getBalance](/reference/ethereum_node_api/accounts_info/eth_getBalance).
...
* `nonce` — refers to the account's nonce. See [eth\_getTransactionCount](/reference/ethereum_node_api/accounts_info/eth_getTransactionCount).
