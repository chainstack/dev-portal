---
title: "trace\_transaction | Fantom"
description: "Fantom API method that traces a specific transaction. It provides a detailed record of all the steps the Ethereum Virtual Machine (EVM) took during the execution, including all the operations performed and the changes made to the blockchain state. This method is available on Erigon only."
---
