...
description: "Fantom trace_transaction method — get a complete trace of all internal calls and state changes for a specific transaction. Available on Erigon nodes only."
---
