---
title: "Beacon Chain API reference: Ethereum consensus layer"
description: "Ethereum Beacon Chain consensus layer API — query validators, attestations, block proposals, the fork choice algorithm, and rewards and penalties."
---
