---
title: "Aurora API reference: NEAR-based EVM JSON-RPC quickstart"
description: "Use the Aurora JSON-RPC API on Chainstack to deploy nodes, send transactions, and query the NEAR-based EVM chain bridged to Ethereum."
---
