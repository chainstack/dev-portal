---
title: "Getting started with the Polygon zkEVM JSON-RPC API"
description: "Get started with the Polygon zkEVM JSON-RPC API on Chainstack. Connect to zkEVM nodes, send requests, and explore zk-rollup specific RPC methods."
---
