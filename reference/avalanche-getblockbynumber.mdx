...
* `object` — a block object, or `null` when no block was found.
  ...
  + `transactions` — array of transaction objects. See [eth\_getTransactionByHash](/reference/avalanche_node_api/transactions_info/eth_getTransactionByHash) for the exact shape.
