...
description: "Arbitrum API method that traces a specific transaction. arbtrace_transaction JSON-RPC method available on the Arbitrum blockchain via Chainstack."
---
