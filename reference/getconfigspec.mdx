...
openapi: /openapi/ethereum_beacon_chain_api/configuration_info/node_config.json GET
  /config/spec
description: "The /eth/v1/config/spec method is designed to provide a comprehensive overview of the current specification parameters of the Ethereum Beacon Chain."
---
