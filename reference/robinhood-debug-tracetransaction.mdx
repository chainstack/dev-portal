---
title: "debug_traceTransaction | Robinhood"
openapi: /openapi/robinhood_node_api/debug_and_trace/debug_traceTransaction.json POST /
description: "Robinhood Chain API method that returns a transaction's traces by replaying it. Reference for debug_traceTransaction on Robinhood Chain via Chainstack."
---
