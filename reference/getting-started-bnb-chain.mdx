---
title: "BNB Smart Chain API reference: JSON-RPC quickstart"
description: "Use the BNB Smart Chain JSON-RPC API on Chainstack to deploy nodes, send transactions, and query the EVM-compatible PoSA blockchain by Binance."
---
