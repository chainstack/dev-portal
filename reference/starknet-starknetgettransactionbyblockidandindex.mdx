...
description: "Starknet API method that returns a transaction by its block ID and index within the block. Available on Starknet via Chainstack JSON-RPC nodes."
---
