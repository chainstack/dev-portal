...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_eth_get_header_by_number.json post /evm
description: "The eth_getHeaderByNumber JSON-RPC method returns the block header information for a given block number. Hyperliquid EVM via Chainstack."
---
