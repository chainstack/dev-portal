...
description: "TRON API method that retrieves a list of all trading pairs available on the TRON decentralized exchange. This method does not require any parameters."
---
