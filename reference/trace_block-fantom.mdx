---
title: "trace\_block | Fantom"
description: "Fantom trace_block method — retrieve execution traces for all transactions in a specific block to analyze smart contract behavior and gas usage patterns."
---
