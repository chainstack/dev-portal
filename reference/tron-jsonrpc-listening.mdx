...
description: "TRON net_listening JSON-RPC method — check if the TRON client is actively accepting network connections via the Ethereum-compatible JSON-RPC interface."
