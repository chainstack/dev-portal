...
description: "Ronin API method that returns an array of log objects for all logs that have occurred since the last poll on. eth_getFilterChanges on Ronin via Chainstack."
---
