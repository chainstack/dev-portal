...
description: "Avalanche API method that returns the information about a transaction from the transaction hash. Use it on Avalanche via Chainstack."
---
...
Here's an example of how you can achieve this with ethers.js:
