...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_debug_trace_block.json post /evm
description: "The debug_traceBlockByHash JSON-RPC method returns detailed trace information for all transactions in a specific block. On Hyperliquid EVM."
---
