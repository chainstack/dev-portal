...
description: "Aurora API method used to remove a filter previously created using one of the following methods: eth_newFilter eth_newBlockFilter. On Aurora."
---
