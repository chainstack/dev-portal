...
openapi: /openapi/hyperliquid_node_api/hypercore_info/info_delegator_rewards.json post /info
description: "The info endpoint with type: \"delegatorRewards\" retrieves comprehensive staking rewards history for a specific user on the Hyperliquid exchange."
---
