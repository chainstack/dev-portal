---
title: trace_call | Arc
openapi: /openapi/arc_node_api/debug_and_trace/trace_call.json POST /
description: "Arc API method that traces a call without creating a transaction. This provides detailed execution traces using the Parity/OpenEthereum trace format."
---
...
The following example traces a `balanceOf` call on the USDC token:
