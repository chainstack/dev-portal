...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_eth_get_storage_at.json post /evm
description: "The eth_getStorageAt JSON-RPC method returns the value stored at a specific storage position in a smart contract. On Hyperliquid EVM."
---
