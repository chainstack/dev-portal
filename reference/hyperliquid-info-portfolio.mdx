...
openapi: /openapi/hyperliquid_node_api/hypercore_info/info_portfolio.json post /info
description: "The info endpoint with type: \"portfolio\" retrieves comprehensive portfolio performance data for a specific user on the Hyperliquid exchange."
---
