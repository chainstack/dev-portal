...
description: "Subscribe to new Ethereum block headers via WebSocket. Receive real-time notifications whenever a new block is added to the Ethereum blockchain."
---
