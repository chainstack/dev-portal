...
description: "Polygon zkEVM API method that checks if a specific block has been virtualized. Reference for zkevm_isBlockVirtualized on zkEVM via Chainstack."
---
