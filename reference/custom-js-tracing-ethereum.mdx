...
description: "Reference for the Custom JS tracing JSON-RPC method on the Ethereum blockchain via Chainstack nodes. Parameters, response, and examples included."
---
