...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_eth_get_filter_logs.json post /evm
description: "The eth_getFilterLogs JSON-RPC method returns an array of all logs matching the filter with the given ID. Hyperliquid EVM via Chainstack."
---
