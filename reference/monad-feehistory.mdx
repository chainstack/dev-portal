...
description: "Monad API method that returns historical gas information, allowing you to track trends over time. Monad API method that returns historical gas information."
---
