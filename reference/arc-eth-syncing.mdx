---
title: eth_syncing | Arc
openapi: /openapi/arc_node_api/chain_info/eth_syncing.json POST /
description: "Arc API method that returns the sync status of the node. Returns false if the node is fully synced, or a sync status object if syncing."
---
