...
description: "Subscribe to new Arbitrum block headers via WebSocket. Receive real-time notifications whenever a new block is added to the Arbitrum blockchain."
---
