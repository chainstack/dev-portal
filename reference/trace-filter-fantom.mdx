...
description: "Fantom trace_filter method — query transaction execution traces across a block range, filtered by sender, receiver, or other criteria for EVM analysis."
---
