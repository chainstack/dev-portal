...
description: "Base API method trace_replayTransaction replays a single transaction using the trace module, returning detailed trace data about its execution."
---
