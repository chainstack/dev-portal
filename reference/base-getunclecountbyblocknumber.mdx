...
description: "Base API method that retrieves the number of uncles in a block, identified by its number. Base API method that retrieves the number of uncles in a block."
---
