...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_eth_get_logs.json post /evm
description: "The eth_getLogs JSON-RPC method returns event logs that match specified filter criteria. Use it on Hyperliquid EVM via Chainstack."
---
