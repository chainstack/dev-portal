...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_eth_chain_id.json post /evm
description: "The eth_chainId JSON-RPC method returns the chain ID of the currently connected blockchain network. Hyperliquid EVM via Chainstack."
---
