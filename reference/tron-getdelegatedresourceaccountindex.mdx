...
description: "Reference docs for the wallet/getdelegatedresourceaccountindex JSON-RPC method on the TRON blockchain, available via Chainstack JSON-RPC nodes."
---
