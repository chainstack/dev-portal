...
openapi: /openapi/hyperliquid_node_api/hypercore_info/info_delegator_history.json post /info
description: "The info endpoint with type: \"delegatorHistory\" retrieves comprehensive staking history for a specific user on the Hyperliquid exchange."
---
