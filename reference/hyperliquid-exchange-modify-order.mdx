...
openapi: /openapi/hyperliquid_node_api/hypercore_exchange/exchange_modify_order.json post /exchange
description: "Modifies an existing order on the Hyperliquid exchange. You can change the price, size, and other parameters without canceling and replacing the order."
---
