...
description: "Subscribe to pending Polygon transactions via WebSocket. Receive real-time notifications when new unconfirmed transactions enter the Polygon mempool."
---
