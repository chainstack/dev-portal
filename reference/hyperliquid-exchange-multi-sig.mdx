---
title: "multiSig | Hyperliquid exchange"
openapi: /openapi/hyperliquid_node_api/hypercore_exchange/exchange_multi_sig.json post /exchange
description: "Submits or signs a multi-signature action for a multi-sig account. Used to propose or approve actions that require multiple signatures."
---
