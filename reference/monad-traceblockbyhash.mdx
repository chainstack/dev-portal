...
description: "Monad API method that returns traces for all transactions in a block specified by block hash. debug_traceBlockByHash on Monad via Chainstack."
---
