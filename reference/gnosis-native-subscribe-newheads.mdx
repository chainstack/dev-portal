...
description: "Subscribe to new Gnosis Chain block headers via WebSocket. Receive real-time notifications whenever a new block is added to the Gnosis blockchain."
---
