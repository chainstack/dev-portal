---
title: "ZKsync API reference: zkSync Era ZK-rollup JSON-RPC"
description: "Use the ZKsync Era JSON-RPC API on Chainstack to deploy nodes, send transactions, and build on the Ethereum L2 ZK-rollup with low-cost scaling."
---
