...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_ots_get_block_transactions.json post /evm
description: "The ots_getBlockTransactions JSON-RPC method retrieves paginated transactions for a specific block on the Hyperliquid EVM blockchain."
---
