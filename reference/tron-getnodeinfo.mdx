...
description: "TRON API method that retrieves information about the current TRON node. This method provides details about the node's version, configuration, network status."
---
