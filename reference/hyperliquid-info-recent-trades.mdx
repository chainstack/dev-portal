...
openapi: /openapi/hyperliquid_node_api/hypercore_info/info_recent_trades.json post /info
description: "The info endpoint with type: \"recentTrades\" retrieves the most recent public trades for a specific asset on the Hyperliquid exchange."
---
