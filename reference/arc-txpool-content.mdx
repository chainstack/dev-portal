---
title: txpool_content | Arc
openapi: /openapi/arc_node_api/txpool/txpool_content.json POST /
description: "Arc API method that returns the contents of the transaction pool. This includes both pending and queued transactions. Arc via Chainstack."
---
