...
openapi: /openapi/hyperliquid_node_api/hypercore_exchange/exchange_spot_send.json post /exchange
description: "Transfers spot tokens directly to another address on the Hyperliquid chain. Spot token transfer on Hyperliquid exchange via Chainstack."
---
