...
description: "The example is a call to the poolinfo of the Gamma MasterChef contract. eth_call JSON-RPC method available on the Optimism blockchain via Chainstack."
---
