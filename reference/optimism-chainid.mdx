...
description: "Optimism API method eth_chainId retrieves the current chain ID, which is a unique identifier for the blockchain network the node is connected to."
---
