...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_eth_get_block_by_hash.json post /evm
description: "The eth_getBlockByHash JSON-RPC method returns information about a block by its hash. Available on Hyperliquid EVM via Chainstack."
---
