...
description: "Subscribe to pending Gnosis Chain transactions via WebSocket. Receive real-time notifications when new unconfirmed transactions enter the mempool."
---
