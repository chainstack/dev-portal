...
description: "Cancel any active Polygon WebSocket subscription with eth_unsubscribe. Pass the subscription ID to stop receiving real-time blockchain event notifications."
---
