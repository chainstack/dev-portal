...
description: "The getnettotals method provides an overview of the node's network traffic, including the total amount of data sent and received. On Bitcoin."
---
