...
description: "Cronos API method that retrieves information about a specific transaction based on the block hash and the transaction index within the block."
---
