---
title: debug_traceTransaction | Arc
openapi: /openapi/arc_node_api/debug_and_trace/debug_traceTransaction.json POST /
description: "Arc API method that returns a detailed trace of a transaction's execution. Reference for debug_traceTransaction on Arc via Chainstack."
---
