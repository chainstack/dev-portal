...
description: "TRON API method that retrieves the current blockchain parameters and configuration settings. wallet/getchainparameters on TRON via Chainstack."
---
