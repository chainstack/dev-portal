...
description: "TRON API method that creates a transaction to place a sell order on the TRON DEX marketplace. wallet/marketsellasset on TRON via Chainstack."
---
