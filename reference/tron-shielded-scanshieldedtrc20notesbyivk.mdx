...
description: "TRON API method that scans for shielded TRC20 notes using an incoming viewing key (ivk). wallet/scanshieldedtrc20notesbyivk on TRON via Chainstack."
---
