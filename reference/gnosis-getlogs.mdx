...
description: "Gnosis Chain API method that returns an array of all logs that match a given filter object. Available on Gnosis via Chainstack JSON-RPC nodes."
---
