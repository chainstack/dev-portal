...
description: "Ronin API method that creates a new filter in the node. This filter allows applications to receive notifications when new blocks are added to the blockchain."
---
