---
title: debug_getBadBlocks | Arc
openapi: /openapi/arc_node_api/debug_and_trace/debug_getBadBlocks.json POST /
description: "Arc API method that returns a list of invalid blocks that the node has encountered. Useful for debugging consensus or block validation issues."
---
