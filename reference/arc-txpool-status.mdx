---
title: txpool_status | Arc
openapi: /openapi/arc_node_api/txpool/txpool_status.json POST /
description: "Arc API method that returns the number of transactions currently pending or queued in the transaction pool. Arc via Chainstack."
---
