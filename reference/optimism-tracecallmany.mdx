...
description: "Executes a list of bundles (a bundle is a collection of transactions), without creating transactions on the. debug_traceCallMany on Optimism via Chainstack."
---
