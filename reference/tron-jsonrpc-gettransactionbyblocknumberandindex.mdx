...
description: "TRON API method that returns information about a transaction by block number and transaction index using Ethereum-compatible JSON-RPC format."
---
