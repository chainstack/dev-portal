...
description: "Reference for the Voluntary exits JSON-RPC method on the Chainstack blockchain via Chainstack nodes. Parameters, response, and examples included."
---
