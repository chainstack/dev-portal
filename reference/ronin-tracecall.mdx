...
description: "Ronin debug_traceCall executes a call on the node like eth_call and returns detailed execution traces for debugging contract interactions on Chainstack."
---
