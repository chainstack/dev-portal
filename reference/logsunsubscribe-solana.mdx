...
description: "Cancel a Solana logs subscription with logsUnsubscribe. Stop receiving real-time WebSocket notifications for program log messages on the network."
---
