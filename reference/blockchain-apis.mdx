---
title: "Overview"
description: "Reference for the Overview JSON-RPC method on the Chainstack blockchain via Chainstack nodes. Parameters, response, and examples included."
---
...
<CardGroup cols={3}>
  ...
  <Card title="Arc" icon="circle-dollar-to-slot" iconType="solid" href="/reference/arc-getting-started" horizontal/>
</CardGroup>
