...
description: "The estimateFee method estimates the fee required to send a message to the TON blockchain. Available on TON v2 via Chainstack JSON-RPC nodes."
---
