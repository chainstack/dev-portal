...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_eth_new_filter.json post /evm
description: "The eth_newFilter JSON-RPC method creates a filter object to notify when logs match the specified criteria. Hyperliquid EVM via Chainstack."
---
