...
description: "Ronin API method that returns information about a transaction by specifying the block number (or tag) and the transaction's index position within the block."
---
