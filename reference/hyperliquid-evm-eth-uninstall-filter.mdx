...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_eth_uninstall_filter.json post /evm
description: "The eth_uninstallFilter JSON-RPC method uninstalls a filter with the given ID. eth_uninstallFilter on Hyperliquid EVM via Chainstack."
---
