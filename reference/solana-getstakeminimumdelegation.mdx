...
description: "The Solana getStakeMinimumDelegation method returns the minimum amount of lamports needed to delegate a stake account. Solana via Chainstack."
---
