...
description: "Plasma API method that returns information about a block by block hash. data — the hash of the block boolean — if true, returns full transaction objects."
---
