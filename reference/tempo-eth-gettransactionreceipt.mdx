...
description: "Tempo API method that returns the receipt of a transaction by transaction hash. Transaction receipts contain information about the execution of a transaction."
---
