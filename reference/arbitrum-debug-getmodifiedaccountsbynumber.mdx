...
description: "Arbitrum API method that retrieves a list of accounts that were modified in a specific block or between two blocks, identified by block number."
---
