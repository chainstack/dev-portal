...
description: "Subscribe to real-time Solana log messages with logsSubscribe. Receive WebSocket notifications whenever new program logs are generated on-chain."
---
