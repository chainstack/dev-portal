---
title: web3_sha3 | Arc
openapi: /openapi/arc_node_api/client_info/web3_sha3.json POST /
description: "Arc API method that returns the Keccak-256 hash of the given data. This is the same hashing algorithm used by Ethereum for various purposes."
---
