---
title: eth_getProof | Arc
openapi: /openapi/arc_node_api/accounts_info/eth_getProof.json POST /
description: "Arc API method that returns the Merkle proof for an account and optionally some storage keys. Available on Arc via Chainstack."
---
