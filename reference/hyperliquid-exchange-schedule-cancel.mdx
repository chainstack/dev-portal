...
openapi: /openapi/hyperliquid_node_api/hypercore_exchange/exchange_schedule_cancel.json post /exchange
description: "Schedules an automatic cancel-all operation at a future time, acting as a dead man's switch for risk management. On Hyperliquid exchange."
---
