...
description: "Starknet API method that returns the execution trace of all transactions in a given block. starknet_traceBlockTransactions on Starknet via Chainstack."
---
