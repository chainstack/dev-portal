...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_eth_get_block_transaction_count_by_number.json post /evm
description: "The eth_getBlockTransactionCountByNumber JSON-RPC method returns the number of transactions in a block by its number. On Hyperliquid EVM."
---
