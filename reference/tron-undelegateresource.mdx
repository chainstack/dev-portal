...
description: "TRON API method that revokes delegated bandwidth or energy resources from another address. wallet/undelegateresource on TRON via Chainstack."
---
