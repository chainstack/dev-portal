...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_trace_block.json post /evm
description: "The trace_block JSON-RPC method returns trace information for all transactions in a specific block. Hyperliquid EVM via Chainstack."
---
