...
description: "Arbitrum API method that traces the execution of eth_call within the context of a specific block's execution. debug_traceCall on Arbitrum via Chainstack."
---
