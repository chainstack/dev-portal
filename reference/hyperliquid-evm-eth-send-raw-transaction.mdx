...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_eth_send_raw_transaction.json post /evm
description: "The eth_sendRawTransaction JSON-RPC method submits a pre-signed transaction to the network for broadcasting and inclusion in a block."
---
