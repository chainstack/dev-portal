...
description: "Reference docs for the eth_getTransactionByBlockNumberAndIndex JSON-RPC method on the Base blockchain, available via Chainstack JSON-RPC nodes."
---
