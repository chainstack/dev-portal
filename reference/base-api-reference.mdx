...
description: "Use the Base JSON-RPC API on Chainstack to deploy nodes, send transactions, and query the Coinbase L2 optimistic rollup built on the OP Stack."
---
