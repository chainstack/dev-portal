...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_trace_filter.json post /evm
description: "The trace_filter JSON-RPC method returns traces matching specified filter criteria. trace_filter on Hyperliquid EVM via Chainstack."
---
