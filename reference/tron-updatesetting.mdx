...
description: "TRON API method that updates the consume user resource percentage setting for a smart contract. wallet/updatesetting on TRON via Chainstack."
---
