---
title: debug_traceBlockByNumber | Arc
openapi: /openapi/arc_node_api/debug_and_trace/debug_traceBlockByNumber.json POST /
description: "Arc API method that returns detailed traces for all transactions in a block specified by block number. Chainstack Arc reference."
---
