...
description: "Aurora API method that allows submitting a signed transaction to the network. Reference for eth_sendRawTransaction on Aurora via Chainstack."
---
