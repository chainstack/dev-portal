...
description: "TRON API method that retrieves a block by its number. This method returns detailed information about a specific block in the TRON blockchain."
---
