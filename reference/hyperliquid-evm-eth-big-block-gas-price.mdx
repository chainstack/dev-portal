...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_eth_big_block_gas_price.json post /evm
description: "The eth_bigBlockGasPrice JSON-RPC method returns the base fee for the next big block on Hyperliquid EVM. Hyperliquid EVM via Chainstack."
---
