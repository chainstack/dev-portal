...
openapi: /openapi/hyperliquid_node_api/hypercore_exchange/exchange_spot_perp_transfer.json post /exchange
description: "Transfers USDC between your spot wallet and perpetual wallet on Hyperliquid. Spot ↔ Perp transfer on Hyperliquid exchange via Chainstack."
---
