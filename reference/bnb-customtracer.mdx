...
description: "Reference for the Custom JS tracer JSON-RPC method on the BNB Chain blockchain via Chainstack nodes. Parameters, response, and examples included."
---
