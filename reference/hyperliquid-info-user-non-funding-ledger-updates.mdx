...
openapi: /openapi/hyperliquid_node_api/hypercore_info/info_user_non_funding_ledger_updates.json post /info
description: "The info endpoint with type: \"userNonFundingLedgerUpdates\" retrieves comprehensive ledger updates for a specific user account on the Hyperliquid exchange."
---
