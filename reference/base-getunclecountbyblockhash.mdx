...
description: "Base API method that retrieves the number of uncles in a block, identified by its hash. Base API method that retrieves the number of uncles in a block."
---
