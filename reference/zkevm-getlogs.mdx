...
description: "Polygon zkEVM API method that returns an array of all logs that match a given filter object. Available on zkEVM via Chainstack JSON-RPC nodes."
---
