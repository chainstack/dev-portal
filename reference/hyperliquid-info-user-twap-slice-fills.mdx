...
openapi: /openapi/hyperliquid_node_api/hypercore_info/info_user_twap_slice_fills.json post /info
description: "The info endpoint with type: \"userTwapSliceFills\" retrieves a user's TWAP (Time-Weighted Average Price) slice fills on the Hyperliquid exchange."
---
