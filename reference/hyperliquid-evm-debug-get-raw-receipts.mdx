...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_debug_get_raw_receipts.json post /evm
description: "The debug_getRawReceipts JSON-RPC method returns the raw receipt data for all transactions in a specific block. On Hyperliquid EVM."
---
