...
description: "Starknet API method that returns a transaction by its hash. It provides the details of a specific transaction that is identified by its unique hash."
---
