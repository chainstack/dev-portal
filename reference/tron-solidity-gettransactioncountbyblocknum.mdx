...
description: "TRON API method that retrieves the transaction count within a solidified block by block number. Available on TRON via Chainstack JSON-RPC nodes."
---
