...
description: "Cancel a Solana slots updates subscription with slotsUpdatesUnsubscribe. Stop receiving detailed WebSocket notifications for slot processing stages."
---
