...
openapi: /openapi/hyperliquid_node_api/hyperevm/evm_eth_fee_history.json post /evm
description: "The eth_feeHistory JSON-RPC method returns historical gas fee data for a range of blocks. Use it on Hyperliquid EVM via Chainstack."
---
