...
description: "Polygon zkEVM API method that enables instant execution of a new message call without requiring the creation of a transaction on the blockchain."
---
