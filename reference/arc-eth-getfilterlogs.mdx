---
title: eth_getFilterLogs | Arc
openapi: /openapi/arc_node_api/filter_handling/eth_getFilterLogs.json POST /
description: "Arc API method that returns an array of all logs matching the filter with the given ID. eth_getFilterLogs on Arc via Chainstack."
---
